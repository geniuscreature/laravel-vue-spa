    ...
    <v-app id="inspire">
        <v-navigation-drawer v-model="drawer" clipped app color="#003252">
            <v-list dense>
                <v-list-item link>
                    <v-list-item-action>
                        <div class="colorful-circle red-circle">0</div>
                    </v-list-item-action>
                    <v-list-item-content>
                        <v-list-item-title><router-link to="/">section</router-link></v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
                <v-list-item link>
                    <v-list-item-action>
                        <div class="colorful-circle blue-circle">0</div>
                    </v-list-item-action>
                    <v-list-item-content>
                        <v-list-item-title><router-link to="/about">section</router-link></v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
                <v-list-item link>
                    <v-list-item-action>
                        <div class="colorful-circle green-circle">0</div>
                    </v-list-item-action>
                    <v-list-item-content>
                ...
                <v-list-item link>
                    <v-list-item-action>
                        <div class="colorful-circle pink-circle">0</div>
                    </v-list-item-action>
                    <v-list-item-content>
                        <v-list-item-title><router-link to="/">section</router-link></v-list-item-title>
                    </v-list-item-content>
                ...
                <v-list-item link>
                    <v-list-item-action>
                        <div class="colorful-circle cyan-circle">0</div>
                    </v-list-item-action>
                    <v-list-item-content>
                        <v-list-item-title><router-link to="/about">section</router-link></v-list-item-title>
                    </v-list-item-content>
